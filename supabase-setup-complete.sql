-- PharmJam Complete Database Setup Script
...
-- Insert sample pharmacy users (without auth_user_id for now)
INSERT INTO pharmacy_users (username, employee_id, first_name, last_name, role, license_number, phone, is_active) VALUES
('admin.pharmacy', 'EMP001', 'Admin', 'User', 'admin', NULL, '+234-800-000-0001', true),
('john.doe.rph', 'RPH001', 'John', 'Doe', 'pharmacist', 'RPH12345', '+234-800-123-4567', true),
('jane.smith.tech', 'TECH001', 'Jane', 'Smith', 'technician', NULL, '+234-800-123-4568', true),
('bob.johnson.cash', 'CASH001', 'Bob', 'Johnson', 'cashier', NULL, '+234-800-123-4569', true),
('alice.brown.mgr', 'MGR001', 'Alice', 'Brown', 'manager', NULL, '+234-800-123-4570', true);
...
INSERT INTO sync_metadata (table_name, sync_direction) VALUES
('pharmacy_users', 'both'),
('products', 'both'),
('inventory', 'both'),
('sales', 'up'),
...
-- ============================================
-- Run these after the script to verify everything was created
